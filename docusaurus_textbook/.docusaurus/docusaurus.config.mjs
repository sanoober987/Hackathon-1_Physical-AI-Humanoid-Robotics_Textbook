...
export default {
  ...
  "projectName": "physical-ai-humanoid-robotics-academy",
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2026 Physical AI & Humanoid Robotics Academy, Developed with precision by Physical AI & Humanoid Robotics."
    },
    "prism": {
      "theme": {
        "plain": {
